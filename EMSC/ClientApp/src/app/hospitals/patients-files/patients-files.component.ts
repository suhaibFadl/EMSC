...
@Component({
  ...
  styleUrls: ['./patients-files.component.css']
})
export class PatientsFilesComponent implements OnInit {
  ...
  selectedPatient!: PatientData;
    ...
    ngOnInit(): void {
      ...
      this.GetAllPatientsOPenFilesByHospitalId();
    ...
    GetAllPatientsOPenFilesByHospitalId() {
      this.pa.clearCache();
      this.pa.GetAllPatientsOpenFilesInsideByHospitalId(this.HospitalUserId.toString()).subscribe(data => {
  ...
  onSelect(patiant: PatientData): void {
    ...
    this.router.navigateByUrl('/hospitals/add-claim/' + patiant.id);
  }
