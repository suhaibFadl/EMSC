...
@Component({
  selector: 'app-traveling-procedures-by-user-id',
  templateUrl: './traveling-procedures-by-user-id.component.html',
  styleUrls: ['./traveling-procedures-by-user-id.component.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class TravelingProceduresByUserIdComponent implements OnInit {
  ...
  //عرض إجراءات التسفير حسب المستخدم الذي قام بحجز التذاكر
  GetTravelTicketsByUserId() {
    this.tr.clearCache();
    this.tr.GetTravelTicketsByUserId(this.UserId.toString()).subscribe(data => {
