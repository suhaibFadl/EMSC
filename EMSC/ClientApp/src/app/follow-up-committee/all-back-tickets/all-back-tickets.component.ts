...
@Component({
  selector: 'app-all-back-tickets',
  templateUrl: './all-back-tickets.component.html',
  styleUrls: ['./all-back-tickets.component.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class AllBackTicketsComponent implements OnInit {
  ...
  displayedColumns: string[] = ['index', 'first', 'second', 'third', 'fourth', 'fifth', 'sixth', 'seventh', 'eihgth', 'ninth', 'ten', 'eleventh', 'twelve', 'thirteen'];
  ...
  GetAllBackTickets() {
    this.fcs.clearCache();
    this.fcs.GetAllBackTickets().subscribe(data => {
