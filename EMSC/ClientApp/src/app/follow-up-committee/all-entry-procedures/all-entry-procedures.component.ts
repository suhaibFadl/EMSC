...
@Component({
  selector: 'app-all-entry-procedures',
  templateUrl: './all-entry-procedures.component.html',
  styleUrls: ['./all-entry-procedures.component.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class AllEntryProceduresComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private formBuilder: FormBuilder  ) { this.datepipe = new DatePipe('en'); }
  ...
  //  this.UserDate = formatDate(new Date(), 'yyyy-MM-dd', 'en');
    ...
    this.GetAllBranches();
    this.GetAllHotelsOutside();
    this.GetAllCountriesFilter();
    this.GetAllEntryProcedures();
  }
  ...
  GetAllHotelsOutside() {
    this.hos.clearCache();
    this.hos.GetAllHotelsOutside().subscribe(result => {
      this.hotels = result;
    });
  }

  GetAllEntryProcedures() {
    this.fcs.clearCache();
    this.fcs.GetAllEntryProcedures().subscribe(data => {
