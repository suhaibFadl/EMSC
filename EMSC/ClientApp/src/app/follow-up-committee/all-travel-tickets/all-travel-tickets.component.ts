...
@Component({
  selector: 'app-all-travel-tickets',
  templateUrl: './all-travel-tickets.component.html',
  styleUrls: ['./all-travel-tickets.component.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class AllTravelTicketsComponent implements OnInit {
  ...
  GetAllTravelTickets() {
    this.fcs.clearCache();
    this.fcs.GetAllTravelTickets().subscribe(data => {
