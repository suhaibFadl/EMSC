...
@Component({
  selector: 'app-all-pending-travel-tickets',
  templateUrl: './all-pending-travel-tickets.component.html',
  styleUrls: ['./all-pending-travel-tickets.component.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class AllPendingTravelTicketsComponent implements OnInit {
  ...
  displayedColumns: string[] = ['index', 'first', 'second', 'third', 'fourth', 'fifth', 'sixth', 'seventh', 'eighth', 'ninth', 'ten'];
  ...
  ngOnInit(): void {
    ...
    this.GetAllPendingTravelTickets();
  }
  ...
  GetAllPendingTravelTickets() {
    this.fcs.clearCache();
    this.fcs.GetAllPendingTravelTickets().subscribe(data => {
